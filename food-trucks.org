...
The business model of social media companies has been to harvest, analyze, exploit, and sell user data. This creates an asymmetric power dynamic between platforms and a platforms users.
